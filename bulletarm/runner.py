...
class SingleRunner(object):
  ...
  def setObjectInitMetaData(self, info=None):
    '''
    Set the initial information of the object in the environment.
    This is used for custom environments where the object information is not set by default.
    '''
    self.env.setObjectInitMetaData(info)
